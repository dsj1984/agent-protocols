...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].1** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].2** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].3.1** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].4.1** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].5.1** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
...
AGENT INSTRUCTION: Ensure all validation and pre-commit hooks pass successfully. Upon successful completion of this task, open the file docs/sprint-[SPRINT_NUMBER]/playbook.md. Find the exact line that starts with - [ ] **[SPRINT_NUMBER].6** and change the - [ ] to - [x] to mark it as complete. Do not modify any other checkboxes.
```
