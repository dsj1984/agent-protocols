// tests/lib/worktree-manager.test.js
//
// Unit / mock-based tests for WorktreeManager. Real-git round-trip tests live
// in worktree-manager.integration.test.js and run only under
// `test:integration` / `npm test` (excluded from the `test:quick` TDD loop).
