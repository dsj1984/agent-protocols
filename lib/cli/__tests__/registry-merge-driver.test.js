...
// Both are asserted as literals rather than imported from the module under
// test: AC-7 is about the EXACT text an operator is told to run, and a test
// that imports the string it is checking can only ever agree with itself.
