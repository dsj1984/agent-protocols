...
Run the `/plan-prd` workflow for the `[SPRINT_NUMBER]`.

1. Read `.agents/workflows/plan-prd.md` to understand your instructions.
1. Execute the steps described in `plan-prd.md` as if you were running the
   command yourself.
...
Run the `/plan-tech-spec` workflow for the `[SPRINT_NUMBER]`.

1. Read `.agents/workflows/plan-tech-spec.md` to understand your instructions.
1. Execute the steps described in `plan-tech-spec.md`.
1. Verify that `docs/sprints/sprint-[SPRINT_NUMBER]-tech-spec.md` has been
   successfully created.

## Step 3 - Playbook Generation

Run the `/plan-playbook` workflow for the `[SPRINT_NUMBER]`.

1. Read `.agents/workflows/plan-playbook.md` to understand your instructions.
1. Execute the steps described in `plan-playbook.md`.
