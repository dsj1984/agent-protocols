/**
 * BookendChainer — auto-invokes `/sprint-close` when the run began with
 * `epic::auto-close`. `/sprint-code-review` and `/sprint-retro` always remain
 ...
 *
 * When `autoClose=true` the chainer invokes `/sprint-close` via a
...
const AUTO_CLOSE_STEP = '/sprint-close';
...
export class BookendChainer {
  ...
  async run() {
    ...
    // Auto-close fires only `/sprint-close`. Review + retro remain operator
